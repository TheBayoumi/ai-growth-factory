...
class ModalContractTests(unittest.TestCase):
    ...
    def test_qwen_omni_runtime_is_complete_and_preflighted(self):
        ...
        success_marker = "Qwen TTS and GPTQ Omni METHOD runtime preflight passed"
    ...
    def test_gptq_omni_load_path_uses_method_compatible_runtime(self):
        ...
        self.assertIn("assert METHOD.GPTQ is not None", self.source)
