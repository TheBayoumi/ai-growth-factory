...
class ModalContractTests(unittest.TestCase):
    ...
    def test_qwen_omni_runtime_is_complete_and_preflighted(self):
        ...
        self.assertIn("assert hasattr(METHOD, 'GPTQ'), METHOD", self.source)
    ...
    def test_gptq_omni_load_path_requires_current_compatible_runtime(self):
